                ...
                <table width="600" cellpadding="20" cellspacing="0" border="0" style="background-color: #ffffff; border-radius: 8px; margin-top: 20px;">
                    ...
                    <tr>
                        <td style="background-color: #ef8e1c; padding: 20px; color: #ffffff;">
                            <h3 style="text-align: center; color: #ffffff;">Your Quote from Bristol Cabwise</h3>
                            <p style="color: #ffffff;">Dear {{ $userName }},</p>
                            <p style="color: #ffffff;">We would like to inform you that we have received your quote request. Our team will contact you soon with the details.</p>
