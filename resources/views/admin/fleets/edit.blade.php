                        ...
                        <form action="{{ route('admin.fleets.update', $fleet->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="number" name="min_booking_hours" class="form-control" placeholder="Minimum Booking Hours" value="{{ $fleet->min_booking_hours }}" required onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="number" name="price_after_50_miles" class="form-control" placeholder="Price after 50 miles" value="{{ $fleet->price_after_50_miles }}" required onkeypress="return event.charCode >= 48 && event.charCode <= 57" >
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="number" name="price_after_100_miles" class="form-control" placeholder="Price after 100 miles" value="{{ $fleet->price_after_100_miles }}" required onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="number" name="price_after_150_miles" class="form-control" placeholder="Price after 150 miles" value="{{ $fleet->price_after_150_miles }}" required onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="number" name="price_after_200_miles" class="form-control" placeholder="Price after 200 miles" value="{{ $fleet->price_after_200_miles }}" required onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="number" name="min_booking_price" class="form-control" placeholder="Minimum Booking Price" value="{{ $fleet->min_booking_price }}" required onkeypress="return event.charCode >= 48 && event.charCode <= 57">
