            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                      <form action="{{ route('admin.settings.update', $date->id) }}" method="POST" enctype="multipart/form-data">
                          @csrf
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" id="daterange" name="date_range" class="form-control" placeholder="Select date range" value="{{$date->date_range?? ''}}" required>
                                    @error('name')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
